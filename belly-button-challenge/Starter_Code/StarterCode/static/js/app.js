...
// Nring in the promise 
const dataPromise = d3.json(url);
console.log("Data Promise: ", dataPromise);

// Merge in the JSON so that the console can log in the data
...
d3.json(url).then(function(data) {
    ...
    // Incorporate all of the demographic info into the page
    ...
    // Call updatePlotly() when a changes toccur to the DOM
    d3.selectAll("#selDataset").on("change", updatePlotly);

    // Dropdown menu item is called when this function is selected
    function updatePlotly() {
        // Use D3 to select the dropdown menu
        var dropdownMenu = d3.select("#selDataset");
        // Assign the value to a variable of the selected item from dropdown menu 
